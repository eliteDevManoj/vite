        ...
        <div class="mb-0 w-screen lg:mx-auto lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
            <div class="!px-10 !py-12 card-body">
                ...
                <div class="mt-8 text-center">
                    ...
                    <p class="text-slate-500 dark:text-zink-200">Sign in to continue to Vite.</p>
                </div>
                ...
                <form action="/login" class="mt-10" id="signInForm" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="email" type="text" id="username" class="<?php $__errorArgs = ['email'];
...
<?php echo $__env->make('auth.layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\vite\resources\views/auth/login.blade.php ENDPATH**/ ?>